...
$thiss = "http://localhost/advanced/frontend/themes/newtheme";
?>
<?php $this->beginPage(); ?>
...
<html>
    <head>
      ...
      <link type="text/css" rel="stylesheet" href="<?php echo $thiss; ?>/css/materialize.min.css"  media="screen,projection"/>
      <link type="text/css" rel="stylesheet" href="<?php echo $thiss; ?>/css/style.css"  media="screen,projection"/>
    ...
    <body>
          ...
          <div class="right col s12 m4 l3"> <!-- Note that "m4 l3" was added -->
            <div class="card">
              <div class="card-image">
                <img src="<?php echo $thiss; ?>/images/ecto.jpg">
      ...
      <script type="text/javascript" src="<?php echo $thiss; ?>/js/materialize.min.js"></script>
